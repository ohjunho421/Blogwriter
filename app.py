...
# OpenAI API 키 설정
os.environ["OPENAI_API_KEY"] = "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"
...
if st.button("생성하기"):
    with st.spinner('생성 중입니다...'):
        ...
        2. 서론 내용에는 타겟들이 평소 '{keyword}'에 대해 어떤 고민이 있는지 '타겟이 겪는 어려움'을 먼저 공감해주고 글쓴이({writer})의 전문성으로 어떻게 해결할 수 있고 어떤 유익한 정보가 있는지 기대 할 수 있도록 작성해줘.
        ...
        6. 효과를 설명하는 소주제 내용을 작성할 때 정량적인 지표를 넣어주고 아래 예시를 사용해서 문맥상 자연스럽게 작성해줘:
            - 1. ~했을 때 평균적으로 ~% 상승하는 효과를 보인 (출처)의 연구자료가 있습니다.
            - 2. (출처)의 연구에 따르면 ~% 상승하는 효과를 보였습니다.
            - 3. 출처가 없다면 작성하지 않고 넘어가도 좋아
            - 4. 5개의 소주제중 2개의 소주제에만 위 조건들을 적용해줘
        ...
        11. 영어로 생각하고 한국어와 영어로만 작성해줘.
        12. 블로그에 복사할 때 보기 좋도록 제목과 함께 섹션을 구분해서 작성해줘.
        13. 글말미에는 부담스럽지 않고 전문성을 강조하면서 매장으로 사람들을 직접 방문할 수 있게끔 후킹해줘.
        """
